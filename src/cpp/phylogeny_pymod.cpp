...
//		.def("setUnrooted", &Tree::setUnrooted)
	...
	class_<TreeManip>("TreeManipBase", init<boost::shared_ptr<Tree> >())
		...
		.def("addLeafToRandomNode", &TreeManip::addLeafToRandomNode)
		.def("assignLeafNumbersRandomly", &TreeManip::assignLeafNumbersRandomly)
		.def("addLeafToRandomEdge", &TreeManip::addLeafToRandomEdge)
