...
void updater_pymod()
	{
   	class_<phycas::MCMCUpdater, bases<AdHocDensity>, boost::noncopyable, boost::shared_ptr<phycas::MCMCUpdater> >("MCMCUpdaterBase", no_init)
		...
		//POLTMP2 .def("setPosteriorTuningParam", &MCMCUpdater::setPosteriorTuningParam)
		//POLTMP2 .def("setPriorTuningParam", &MCMCUpdater::setPriorTuningParam)
		...
		//POLTMP2 .def("setBoldness", &MCMCUpdater::setBoldness)
