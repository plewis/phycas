...
A list of related web sites (section~\ref{section:websites}) is followed by one final section (section~\ref{section:install}) devoted to the details of getting \phycas\ (and \python) installed on your computer system.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
If you find yourself using \phycas\ often, and thus end up typing  \code{from phycas import *} over and over, you should consider installing \ipythonurl. Once installed, create a default configuration profile as follows
\begin{verbatim}
...
The setting \opt{sump}{file} specifies the name of the parameter file to analyze. The setting \opt{sump}{burnin} is the number of lines of parameter values to skip. This value should always be at least 1 because the first line in the tree file represents the starting values, which do not represent a valid sample from the posterior distribution. All statistics computed by the \cmd{sump} method are based on the number of sampled trees remaining after the burn-in samples have been removed from consideration. For example, if there are 101 lines of sampled parameters in the input parameter file, and \opt{sump}{burnin} is 1, all posterior probabilities will be computed using 100 in the denominator (not 101).
\end{samepage}
...
\pointup\ The setting \opt{sumt}{trees} specifies the name of the tree file to analyze. Note that you need not run the \cmd{sumt} command from the same script that starts the MCMC analysis; all this command needs is the name of an existing tree file, and thus it can be run at any time. The setting \opt{sumt}{burnin} is the number of sampled tree topologies to skip. As with the \opt{sump}{burnin} setting, this value should always be at least 1 because the first tree in the tree file is the starting tree, which is never a valid sample from the posterior distribution. All statistics computed by the \cmd{sumt} method are based on the number of sampled trees remaining after the burn-in trees have been removed from consideration. For example, if there are 101 trees in the input tree file, and \opt{sumt}{burnin} is 1, all posterior probabilities will be computed using 100 in the denominator (not 101).
\end{samepage}
...
%%%%% Web sites %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Web sites}\label{section:websites}
...
%%%%% Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection{Settings}\label{subsection:phycassettings}
%\input{cmdsettings}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% Design principles %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\section{Design principles}\label{section:designprinciples}
