...
#
# scripts/create_src_distr.sh phycas-x.x.x
#
# This will create a dist directory and a directory phycas-x.x.x within dist.
# The phycas-x.x.x directory will be archived to create a phycas-x.x.x-src.tar.gz file
# inside dist.
